...
const listings = [
 ...
 function BookingRequests(props,{navigation}) {
  ...
  return (
    ...
    <Screen style={styles.screen}>
          <Text> You have Some New Orders Available</Text>
      <FlatList showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} style={{backgroundColor:'#fff'}}
        data={posts}
      ...
      />
    <SecondryButton title="Confirm" onClick={() => props.navigation.navigate('Profile')}></SecondryButton>
    </Screen>
