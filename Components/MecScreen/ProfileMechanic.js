...
const listings = [
 ...
 function ProfileMechanic(props,{navigation}) {
    ...
    const fetchposts = async() =>
    {
          try{
           ...
           await firebase.firestore()
            .collection("MechProfile").doc(firebase.auth().currentUser.uid).collection("UserProfile")
            .get()
            .then((querySnapshot) =>
                 {
  ...
  return (
    ...
    <SecondryButton title="Edit Profile" onClick={() => props.navigation.navigate('Edit Profile')}></SecondryButton>
    </Screen>
...
export default ProfileMechanic;
