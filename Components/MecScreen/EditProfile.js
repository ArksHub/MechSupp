...
import ProfileMechanic from './ProfileMechanic';
...
//-----------------------------------------------------------------------------------------------------------
const childpath= `ProfileMech/${firebase.auth().currentUser.uid}/${Math.random().toString(36)}`;
...
firebase.firestore()                                  
.collection("MechProfile").doc(firebase.auth().currentUser.uid).collection("UserProfile").add({ 
  downloadURL,
  Name,
  Contact,
  CNIC,
 ...
 const SendData = (downloadURL) => { 
    firebase.firestore()                                  
    .collection("InstantRepair").add({ 
      downloadURL,
      Name,
      Contact,
      CNIC,
