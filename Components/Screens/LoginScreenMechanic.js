...
function LoginScreenMechanic({navigation}) {
...
//------------------------------------------------------------------Ends here
    return (
        ...
        <SecondryButton onClick={() => navigation.navigate("Register as Customer")} title="Sign Up" />
        </View>
...
export default LoginScreenMechanic;
