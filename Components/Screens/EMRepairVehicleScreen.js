...
const listings = [
 ...
 function EMRepairVehicleScreen(props,{navigation}) {
  ...
  return (
    ...
    <Screen style={styles.screen}>
      <Text>You can Contact our Registered mechanics for emergency Support</Text>    
...
export default EMRepairVehicleScreen;
